...
function Impression() {
  return(
    <div className="min-h-[90vh] flex-col justify-center items-center bg-slate-100 text-black">
      <div className="bg-slate-100 flex-col justify-center items-center min-h-1/6 max-w-3xl m-auto text-black px-8 py-10 font-medium">
      ...
      <div className='flex-col sm:flex-row flex justify-center items-center max-w-3xl h-auto px-8 py-10 m-auto'>
        <div className='sm:w-4/6 px-4 pb-8 flex-col font-medium'>
          <div className='mb-3'>
