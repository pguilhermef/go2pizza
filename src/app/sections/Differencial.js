...
function Differencial() {
  return (
    <div className="min-h-screen flex-col justify-center items-center bg-white">
      ...
      <div className="grid grid-cols-2 grid-rows-2 gap-4 justify-center items-center p-4 bg-white max-w-4xl m-auto">
        {cardsData.map((card) => (
